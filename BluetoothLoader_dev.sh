...
if unzip -o "BluetoothData/dev.zip" -d "BluetoothData/"; then

	if [ -d "/mnt/mmc/MUOS/application/.bluetooth" ]; then
	  rm -r "/mnt/mmc/MUOS/application/.bluetooth"
	fi

	mv "BluetoothData/bltMuos-dev/.bluetooth" "/mnt/mmc/MUOS/application/"
	mv "BluetoothData/bltMuos-dev/Bluetooth.sh" "/mnt/mmc/MUOS/application/"
	...
	cp "BluetoothData/bltMuos-dev/BluetoothLoader_dev.sh" "/mnt/mmc/MUOS/task/BluetoothLoader_dev.sh"
