...
if unzip -o "BluetoothData/main.zip" -d "BluetoothData/UnzipData/"; then
	...
	cp "BluetoothData/UnzipData/bltMuos-main/BluetoothLoader.sh" "mnt/mmc/MUOS/task/BluetoothLoader.sh"
